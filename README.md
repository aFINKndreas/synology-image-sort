...
synology-image-sort/0.0.6 darwin-x64 node-v12.13.1
...
_See code: [src/commands/watch.ts](https://github.com/afinkndreas/synology-image-sort/blob/v0.0.6/src/commands/watch.ts)_
<!-- commandsstop -->
